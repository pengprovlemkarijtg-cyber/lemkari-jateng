const pengurusOrganisasi = [
  {
    ...
    nama: "Dr. Endang Yuliyanti, S.H., M.H.",
  },
  {
    jabatan: "ANGGOTA",
    nama: "H. Bayu Agung Pribadi, S.Km., S.H., M.H.",
  },
];
    ...
    <main>
      ...
      <section className="page-hero">
        <div className="container page-hero-content">
          ...
          <h1>
            Bidang Penegakan Hukum Organisasi
          </h1>

          <p>
            Susunan pengurus Bidang Penegakan Hukum Organisasi
          </p>
